    ...
    <>
      ...
      <div>
        ...
        <form onSubmit={savePlace}>
          {preInput("Title", "title of your place should be short and catchy")}
          <input
            type="text"
            value={title}
          ...
          />
          {preInput("Address", "for example: 123 Main Street, New York")}
          <input
            type="text"
            value={address}
          ...
          {preInput(
            "Extra information",
            "Add any extra information about your place here"
          )}
          <textarea
            value={extraInfo}
